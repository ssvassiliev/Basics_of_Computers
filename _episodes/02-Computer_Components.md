...
## 11. Storage media types and their characteristics (Storage devices).
...
## 12. What is the difference between RAM and long term storage? (Flow of information in computers)
...
## 13. Characteristics of storage devices
### What to Consider When Buying A Data Storage Device?
...
## 15. Flash memory 101 - what you need to know.
...
There are a number of terms you will encounter, such as SLC, MLC, TLC, SATA III, NVMe, and M.2. What does it all mean? Let’s take a look!
...
#### Poll #3.
- How many charge levels are used in a triple level cell? 
    1. 3
    2. 6
    3. 8
